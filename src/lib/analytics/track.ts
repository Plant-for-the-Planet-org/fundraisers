 ...
 *
 * No-ops when the tracker is absent: any host without NEXT_PUBLIC_UMAMI_WEBSITE_ID set or with COLLECT_INSIGHTS=false, and any visitor blocking the script. Never pass anything that identifies a person.
 */
