...
export function ThemeSettings() {
  ...
  return (
    <div className='theme-settings flex flex-col gap-3 rounded-xl bg-base/20 dark:bg-white/15 text-foreground p-4 shadow-none border-2 border-white dark:border-none'>
