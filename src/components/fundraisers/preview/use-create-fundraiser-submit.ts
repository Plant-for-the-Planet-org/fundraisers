...
/**
 * Shared create-fundraiser submit logic, consumed by both the primary CTA
 * (`CreateFundraiserButton`) and the preview dialog's Save button. `submit` is
 * a ready `onClick` handler that validates the form before running.
 */
export function useCreateFundraiserSubmit() {
